...
export declare type Series = 'test:series' | 'captcha-deterrent' | '3060ti' | '3070' | '3080' | '3090' | 'darkhero' | 'rx6800' | 'rx6800xt' | 'rx6900xt' | 'ryzen5600' | 'ryzen5800' | 'ryzen5900' | 'ryzen5950' | 'sonyps5c' | 'sonyps5de' | 'sf' | 'xboxsx' | 'xboxss';
