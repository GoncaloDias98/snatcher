...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      1660: envOrArray(process.env.DISCORD_NOTIFY_GROUP_3090),
			'1660S': envOrArray(process.env.DISCORD_NOTIFY_GROUP_1660S),
			2060: envOrArray(process.env.DISCORD_NOTIFY_GROUP_2060),
			'2060S': envOrArray(process.env.DISCORD_NOTIFY_GROUP_2060S),
			2070: envOrArray(process.env.DISCORD_NOTIFY_GROUP_2070),
			'2070S': envOrArray(process.env.DISCORD_NOTIFY_GROUP_2070S),
			'2080S': envOrArray(process.env.DISCORD_NOTIFY_GROUP_2080S),
			'2080TI': envOrArray(process.env.DISCORD_NOTIFY_GROUP_2080TI),
			rx570: envOrArray(process.env.DISCORD_NOTIFY_GROUP_rx570),
			rx5700: envOrArray(process.env.DISCORD_NOTIFY_GROUP_rx5700),
			rx5700xt: envOrArray(process.env.DISCORD_NOTIFY_GROUP_rx5700xt),
			rx580: envOrArray(process.env.DISCORD_NOTIFY_GROUP_rx580),
			rx590:envOrArray(process.env.DISCORD_NOTIFY_GROUP_rx590),
      'captcha-deterrent': [],
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      1660: envOrNumber(process.env.MAX_PRICE_SERIES_3090),
			'1660S': envOrNumber(process.env.MAX_PRICE_SERIES_1660S),
			2060: envOrNumber(process.env.MAX_PRICE_SERIES_2060),
			'2060S': envOrNumber(process.env.MAX_PRICE_SERIES_2060S),
			2070: envOrNumber(process.env.MAX_PRICE_SERIES_2070),
			'2070S': envOrNumber(process.env.MAX_PRICE_SERIES_2070S),
			'2080S': envOrNumber(process.env.MAX_PRICE_SERIES_2080S),
			...
			rx590: envOrNumber(process.env.MAX_PRICE_SERIES_rx590),
      'captcha-deterrent': 0,
